...
<div class="login-section">
    ...
    <a href="patientLogin.jsp"
       class="btn btn-success px-4 me-3">
        Patient
    </a>
    ...
    <div class="row text-center">
        ...
        <div class="col-md-6">
            ...
            <div class="offer-card">
                ...
                <p>
                    Get Extra 25% off on CIPLAs products
                </p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p style="font-size:14px;">
                    Your trusted online medical system for fast medicine delivery
