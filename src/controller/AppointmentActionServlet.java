    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!"APPROVE".equals(action) && !"REJECT".equals(action)) {
            response.sendRedirect(
                request.getContextPath() + "/jsp/viewAppointments.jsp?error=InvalidAction"
            );
            return;
        }
        ...
        try {
            ...
            response.sendRedirect(
                request.getContextPath() + "/jsp/viewAppointments.jsp?msg=Updated"
            );
            ...
            response.sendRedirect(
                request.getContextPath() + "/jsp/viewAppointments.jsp?error=ServerError"
            );
